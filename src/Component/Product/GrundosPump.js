            ...
            <div className="d-flex flex-wrap text-center justify-content-center">
                <div className="card card-w" >
                    ...
                    <div className="card-body">
                        ...
                        <a href="/PDF's/GRUNDFOS CM BOOSTER  brochure (1).pdf" className="btn mb-2  btn-outline-success">VIEW DETAILS</a>
                ...
                <div className="card card-w">
                    <img className="card-img-top" src={Img4} alt="hydroPump" />
                    <div className="card-body">
                ...
                <div className="card card-w">
                    <img className="card-img-top" src={Img5} alt="scalaPump" />
                    <div className="card-body">
